	...
	*.........................................................................
	...
	preserve // Save the current dataset state
		...
		esttab `all_models' using "cross-sectors.tex", replace ///
			...
			order(_cons) ///
			varlabels(_cons "Intercepto" L.r_gdp "PBI: r(-1)" L.r_agriculture "Agropecuario: r(-1)" L.r_fishing "Pesca: r(-1)"L.r_manufacturing "Manufactura: r(-1)" L.r_mining "Minería e Hidrocarburos: r(-1)" L.r_construction "Construcción: r(-1)" L.r_commerce "Comercio: r(-1)" L.r_services "Otros Servicios: r(-1)" L.r_electricity "Electricidad y Agua: r(-1)") ///
			noobs ///
			star(* 0.1 ** 0.05 *** 0.01) ///
			tex ///
			longtable
