	...
	use cum_temp_panel_data_cleaned, clear
		...
		* global
		...
		program define base_year_dummy_process_sector_r
			...
			local indep_vars time_trend c.time_trend#i.dummy_`sector'
		...
		foreach sector of global sectors {
			...
			esttab fe_`sector' xtscc_fe_`sector' re_`sector' xtscc_re_`sector' using "robustness_analysis_2.tex", append ///
