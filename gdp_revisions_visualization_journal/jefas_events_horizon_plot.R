...
selected_vintages <- as.Date(c("2006-05-01", "2012-06-01"))
...
# Visualization
#*******************************************************************************
color_values <- c("2006m05" = "#3366FF", "2012m06" = "#E6004C",
                  "2006m05 now" = "#3366FF", "2012m06 now" = "#E6004C")

shape_values <- c("2006m05" = 16, "2012m06" = 17)
...
horizon_plot <- ggplot(df_long, aes(x = horizon, y = value, color = series_label)) +
  ...
  scale_color_manual(values = color_values,
                     breaks = c("2005m05","2012m06",
                                "2005m05 now","2012m06 now")) +
  ...
  guides(
    color = guide_legend(
      ...
      override.aes = list(
        shape = c(16, 17),             # shapes only for releases
...
plot_output_file <- file.path(output_dir, "Fig_Nwc.png")
