...
***
		...
		*** Program: jefas_unbiassdness_second_sample.do
	...
	* Set as global vars
	...
	use r_e_z_gdp_releases, clear
		...
		* Export to excel file
		...
		export excel using "$tables_folder/gdp_r_unbiassdness_second_sample.xlsx", ///
	...
	use r_e_z_gdp_releases, clear
		...
		* Export to excel file
		...
		export excel using "$tables_folder/gdp_e_unbiassdness_second_sample.xlsx", ///
    firstrow(variable) replace
	...
	use r_e_z_gdp_releases, clear
		...
		* Export to excel file
		...
		export excel using "$tables_folder/gdp_z_unbiassdness_second_sample.xlsx", ///
    firstrow(variable) replace
