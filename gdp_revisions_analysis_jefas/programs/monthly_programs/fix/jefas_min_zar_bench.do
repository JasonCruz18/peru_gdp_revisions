...
***
	...
	* Set as global vars
	...
	use e_gdp_releases
		...
		merge 1:1 vintages_date using gdp_bench_e_cleaned
	...
	use gdp_bench_e_dummies_cleaned, clear
		...
		** Set common information using regression for model III (H1) to keep if !missing(residuals)
		...
		qui {
			tsset vintages_date
			newey e_11_gdp c.gdp_release_11##i.gdp_release_11_dummy, lag(1) force
	...
	list variable n coef_1 coef_2 coef_3 coef_4, noobs clean
		...
		* Export to excel file
		...
		export excel using "$tables_folder/gdp_mz_bench.xlsx", ///
