	...
	* Set as global vars
		...
		forval i = 2/12 {
			...
			if !_rc {
				...
				capture {
					...
					local coef_2 = M[1,3] // r_`i+1'_gdp_dummy
					local coef_3 = M[1,5] // r_`i+1'_gdp*r_`i+1'_gdp_dummy
	...
	list variable n coef_1 coef_2 coef_3, noobs clean
		...
		* Export to excel file
		...
		export excel using "$tables_folder/gdp_r_e_predictibility_noconstant_bench.xlsx", ///
